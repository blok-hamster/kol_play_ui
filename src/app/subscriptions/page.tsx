        ...
        <div className="p-4 sm:p-6 space-y-6 sm:space-y-8">
          ...
          <div className="flex items-center justify-between sm:justify-end gap-2 sm:gap-3">
            <Button
              ...
              className="flex items-center space-x-1.5 sm:space-x-2 flex-1 sm:flex-none"
            >
              <RefreshCw className={`w-3.5 h-3.5 sm:w-4 sm:h-4 ${isLoadingSubscriptions ? 'animate-spin' : ''}`} />
              <span className="text-[11px] sm:text-sm">Refresh</span>
            </Button>
            <Link href="/kols" className="flex-1 sm:flex-none">
              <Button size="sm" className="flex items-center space-x-1.5 sm:space-x-2 w-full">
                <Plus className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                <span className="text-[11px] sm:text-sm">Add New</span>
              </Button>
            </Link>
          </div>
            ...
            <div className="flex flex-col gap-4 mb-4 sm:mb-6">
              <div className="flex items-center justify-between">
                <h2 className="text-lg sm:text-xl font-semibold text-foreground">
                  Subscriptions <span className="text-muted-foreground font-normal">({filteredSubscriptions.length})</span>
                </h2>
              </div>
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    className="pl-10 pr-4 py-2 border border-border rounded-lg bg-background text-foreground placeholder:text-muted-foreground focus:ring-2 focus:ring-primary focus:border-transparent w-full text-sm"
                  />
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button
                    ...
                    className={`flex items-center space-x-1.5 h-9 ${showFilters ? 'bg-muted border-primary/50' : ''}`}
                  >
                  ...
                  {/* View Mode Toggle */}
                  <div className="flex items-center border border-border rounded-lg overflow-hidden flex-1 sm:flex-none">
                    <button
                      type="button"
                      aria-label="Grid view"
                      onClick={() => setViewMode('grid')}
                      className={`px-3 py-2 h-9 text-xs flex items-center gap-2 flex-1 sm:flex-none justify-center ${viewMode === 'grid' ? 'bg-muted text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                    >
                    ...
                    <button
                      ...
                      className={`px-3 py-2 h-9 text-xs flex items-center gap-2 border-l border-border flex-1 sm:flex-none justify-center ${viewMode === 'list' ? 'bg-muted text-foreground' : 'text-muted-foreground hover:text-foreground'}`}
                    >
