...
export default function AnalyticsDashboardPage() {
    ...
    const handleAnalyze = async (manualInput?: string) => {
        ...
        try {
            ...
            // Handle ML Prediction (Primary source for Traffic Light)
            ...
            } else if (sentimentResult.status === 'fulfilled') {
                // Fallback: use Sentiment decision if ML prediction fails
                setPrediction({
                    label: sentimentResult.value.decision,
